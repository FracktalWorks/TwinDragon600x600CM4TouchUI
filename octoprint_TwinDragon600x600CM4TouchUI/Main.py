...
calibrationPosition = {'X1': 50, 'Y1': 50, #110, 18
                       'X2': 670, 'Y2': 50, #510, 18
                       'X3': 360, 'Y3': 570, #310, 308
                       'X4': 360, 'Y4': 20
                       }

tool0PurgePosition = {'X': 20, 'Y': -100}
tool1PurgePosition = {'X': 690, 'Y': -100}

ptfeTubeLength = 2500 #2400 for 600x600, 1500 for 600x300 keep as multiples of 300 only
